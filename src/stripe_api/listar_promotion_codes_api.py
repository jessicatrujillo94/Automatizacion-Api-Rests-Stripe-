...
def listar_promotion_codes(filter=None):
    headers = build_headers()
    endpoint = PromotionCodeEndpoints.GET_PROMOTION_CODES.value
    response = StripeAPI(BASE_URL).get(endpoint=endpoint, headers=headers, params=filter)
