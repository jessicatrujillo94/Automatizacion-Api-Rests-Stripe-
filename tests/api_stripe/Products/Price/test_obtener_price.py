...
@allure.feature("Feature: Obtener Prices")
@allure.story("HU: HU006-Consultar Prices")
@pytest.mark.functional
@pytest.mark.smoke
def test_GETP001_obtener_price_valido(one_price_id):
    allure.dynamic.label("owner", "Jessica Trujillo")
    allure.dynamic.tag("functional", "smoke", "api", "price")
...
def test_GETP008_obtener_price_header_autorizacion_vacio(one_price_id):
    allure.dynamic.label("owner", "Jessica Trujillo")
    allure.dynamic.tag("security", "negative", "api", "price")
