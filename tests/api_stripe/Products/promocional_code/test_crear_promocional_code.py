...
def test_POSTPMCD001_crear_codigo_promocional_valido(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD001_crear_codigo_promocional_valido")
    respuesta = crear_codigo_promocional_valido(coupon_id)
...
@pytest.mark.functional
def test_POSTPMCD003_crear_codigo_promocional_duplicado(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD003_crear_codigo_promocional_duplicado")
    respuesta = crear_codigo_promocional_duplicado(coupon_id)
    assert_creacion_duplicado(respuesta)


@pytest.mark.functional
def test_POSTPMCD004_crear_codigo_promocional_token_invalido(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD004_crear_codigo_promocional_token_invalido")
    respuesta = crear_codigo_promocional_token_invalido(coupon_id)
    assert_creacion_token_invalido(respuesta)


@pytest.mark.functional
def test_POSTPMCD005_crear_codigo_promocional_sin_token(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD005_crear_codigo_promocional_sin_token")
    respuesta = crear_codigo_promocional_sin_token(coupon_id)
    assert_creacion_sin_token(respuesta)


@pytest.mark.regression
def test_POSTPMCD006_validar_estructura_respuesta(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD006_validar_estructura_respuesta")
    respuesta = crear_codigo_promocional_estructura_respuesta(coupon_id)
    try:
        assert_estructura_respuesta_promotion_code(respuesta)
    finally:
        eliminar_codigo_promocional(respuesta)


@pytest.mark.regression
def test_POSTPMCD007_validar_tipos_datos(one_coupon_id):
    coupon_id = one_coupon_id
...
@pytest.mark.regression
def test_POSTPMCD008_validar_respuesta_json_header(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD008_validar_respuesta_json_header")
    respuesta = crear_codigo_promocional_validar_json_header(coupon_id)
    assert_respuesta_json_header(respuesta)


@pytest.mark.performance
def test_POSTPMCD009_medir_tiempo_respuesta(one_coupon_id):
    coupon_id = one_coupon_id
    ...
    assert_tiempo_respuesta(respuesta, max_response_time=2)


@pytest.mark.functional
def test_POSTPMCD010_crear_codigo_promocional_con_limite_uso(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD010_crear_codigo_promocional_con_limite_uso")
    respuesta = crear_codigo_promocional_limite_uso(coupon_id)
    try:
...
def test_POSTPMCD011_validar_coupon_existente(one_coupon_id):
    coupon_id = one_coupon_id
    logger.info("Iniciando test_POSTPMCD011_validar_coupon_existente")
    respuesta = crear_codigo_promocional_coupon_inexistente(coupon_id)
    assert_coupon_existente(respuesta)


@pytest.mark.functional
def test_POSTPMCD012_crear_codigo_promocional_active_invalido(one_coupon_id):
    coupon_id = one_coupon_id
...
@pytest.mark.functional
def test_POSTPMCD013_crear_codigo_promocional_code_case_sensitive(one_coupon_id):
    coupon_id = one_coupon_id
...
@pytest.mark.functional
def test_POSTPMCD014_crear_codigo_promocional_permisos_restringidos(one_coupon_id):
    coupon_id = one_coupon_id
